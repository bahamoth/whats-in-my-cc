...
//
// The rail is CLIPPED at its end nodes — it does not overshoot the ▢/✓: a
// 'start' row draws the rail from the node (card vertical center) DOWN; an 'end'
// row draws it from the top UP TO the node; 'mid' rows draw full height. Nodes
// sit at the card's vertical center with a short connector so the rail reads as
// emanating from the start card and terminating into the end card.
