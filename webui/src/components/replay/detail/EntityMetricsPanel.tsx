...
//
// DRY: the response-row rendering (Row + InfoTip + TIPS) lives here once and is
// reused by `ResponseMetricsPanel` (the thinking-marker path) via the exported
// `ResponseMetricsRows`.
...
/** The per-response metric rows, shared by the assistant/thinking node path and
